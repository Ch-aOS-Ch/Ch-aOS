...
A bit more can be found in [Our own documentation](../Souls/connectors.md) and also in [Pyinfra's documentation](https://docs.pyinfra.com/en/3.x/api/connectors.html).
