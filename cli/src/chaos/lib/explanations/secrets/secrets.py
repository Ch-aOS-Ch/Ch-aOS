class SecretsExplain():
    _order = ['sops', 'bw', 'bws', 'op', 'age', 'gpg', 'vault', 'edit', 'print', 'cat', 'rotate-add', 'rotate-rm', 'shamir', 'import', 'export', 'providers']
    ...
    def explain_age(self, detail_level='basic'):
        return {
            ...
            'learn_more': ['age GitHub Repository', 'Arch Wiki: age', 'ssh-to-age Tool']
        }
    ...
    def explain_secrets(self, detail_level='basic'):
        return {
            ...
            'learn_more': ['man sops', 'Mozilla SOPS GitHub Repository', 'bitwarden CLI Documentation', '1Password CLI Documentation'],
...
chaos secrets shamir 0 2"""
    ...
    def explain_import(self, detail_level='basic'):
        return {
            ...
            'examples': [{
                'yaml': "chaos secrets import bw age --item-id '...' "
            }]
        }
