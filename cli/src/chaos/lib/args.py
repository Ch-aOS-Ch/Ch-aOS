...
def argParsing():
    ...
    secBwsExport.add_argument('-t', '--key-type', choices=['age', 'gpg'], help="The type of key you want to export.")
    ...
    secBwExport.add_argument('-t', '--key-type', choices=['age', 'gpg'], help="The type of key you want to export.")
    ...
    secOpExport.add_argument('-t', '--key-type', choices=['age', 'gpg'], help="The type of key you want to export.")
    secOpExport.add_argument('-u', '--url', help="1Password item URL where to export the key (format: op://vault/item).")
    secOpExport.add_argument('-k', '--keys', help="Path to the key file to be exported (required for age keys, needs to be the file created by age-keygen).").completer = FilesCompleter()
    ...
    provider_group_edit.add_argument('-o', '--from-op', nargs=2, metavar=('URL', 'KEY_TYPE'), help="[Manual] Decrypt with a key from 1Password. KEY_TYPE is 'age' or 'gpg'.")
    ...
    provider_group_print.add_argument('-bs', '--from-bws', nargs=2, metavar=('ITEM_ID', 'KEY_TYPE'), help="[Manual] Decrypt with a key from Bitwarden Secrets. KEY_TYPE is 'age' or 'gpg'.")
    provider_group_print.add_argument('-o', '--from-op', nargs=2, metavar=('URL', 'KEY_TYPE'), help="[Manual] Decrypt with a key from 1Password. KEY_TYPE is 'age' or 'gpg'.")
    ...
    provider_group_cat.add_argument('-o', '--from-op', nargs=2, metavar=('URL', 'KEY_TYPE'), help="[Manual] Decrypt with a key from 1Password. KEY_TYPE is 'age' or 'gpg'.")
