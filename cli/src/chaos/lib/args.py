...
def argParsing():
    ...
    secRotateRemove.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    secList.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    secRotateAdd.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    secShamir.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleCreate.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleEdit.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleEncrypt.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleRead.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleFind.add_argument('--team', type=str, help="Team to be used.")
    ...
    rambleMove.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleUpdate.add_argument('-t', '--team', type=str, help="Team to be used.")
    ...
    rambleDel.add_argument('-t', '--team', type=str, help="Team to be used.")
